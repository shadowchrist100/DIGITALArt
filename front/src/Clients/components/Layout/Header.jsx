        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex-1 hidden max-w-2xl mx-8 md:flex">
            <form onSubmit={handleSearch} className="relative flex items-center w-full gap-2">
              <div className="relative flex-1">
                ...
                <input type="text" placeholder="Plombier, électricien, menuisier..."
          ...
          <div className="items-center hidden gap-3 lg:flex">
            {isLoggedIn ? (
              ...
              <>
                <Link to="/login">
                  <button className="px-5 py-2.5 border rounded-xl transition-all font-semibold flex items-center gap-2 hover:shadow-md"
                    style={{ backgroundColor: 'var(--light)', color: '#ff7e5f', borderColor: '#ff7e5f' }}>
                    <User className="w-4 h-4" />
                    <span>Connexion</span>
                  </button>
                </Link>
                <Link to="/register">
                  <button className="px-5 py-2.5 text-white font-semibold rounded-xl transition-all shadow-md hover:shadow-lg flex items-center gap-2"
              ...
              {isLoggedIn ? (
                ...
                <>
                  ...
                  <Link to="/register" onClick={() => setIsOpen(false)}>
                    <button className="flex items-center justify-center w-full gap-2 px-4 py-3 font-semibold text-white transition-all shadow-md rounded-xl hover:shadow-lg"
                      style={{ backgroundColor: '#ff7e5f' }}>
                      <UserPlus className="w-4 h-4" />
                      <span>S'inscrire</span>
                    </button>
