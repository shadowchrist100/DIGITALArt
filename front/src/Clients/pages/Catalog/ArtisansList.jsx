...
//import { artisanAPI } from '../../../../services/api'; // adapte le chemin
...
function ArtisanCard({ artisan }) {
    ...
    const location = artisan.localisation ?? '';
    const photo = artisan.image_url ?? artisan.photo_profil ?? null;
    const rating = artisan.avis_avg_note ? Number(artisan.avis_avg_note).toFixed(1) : null;
    const avisCount = artisan.avis_count ?? 0;
                ...
                <div className="mb-4">
                    <div className="flex items-start justify-between mb-2">
                        <div>
                            ...
                            <p className="text-sm font-semibold" style={{ color: 'var(--accent)' }}>{specialite}</p>
                        </div>
    ...
    useEffect(() => {
        ...
        const fetchArtisans = async () => {
            ...
            try {
                ...
                if (urlCategory !== 'all') params.set('specialite', urlCategory);
                ...
                // (artisanAPI.index ne supporte pas les params ni AbortController)
                    ...
                    {showFilters && (
                        <div className="pt-6 mt-6 border-t" style={{ borderColor: 'var(--gray-dark)' }}>
                            <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                                <div>
                                    <label className="block mb-2 text-sm font-bold" style={{ color: 'var(--dark)' }}>Spécialité</label>
